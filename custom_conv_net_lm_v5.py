...
dataset_path = 'dataset/ucf_18/patch_512/'
version = 'v5.3.1'
lm_loss = 'bcep'
optimizer = 'adam'
INPUT_SIZE = 512
...
if not resume:
    ...
    # 256
    model = Conv2D(filters=64, kernel_size=(3, 3), activation='relu', kernel_initializer=init, padding="same")(inputs)
    model = BatchNormalization()(model)
    model = Conv2D(filters=64, kernel_size=(3, 3), activation='relu', kernel_initializer=init, padding="same")(model)
    model = BatchNormalization()(model)
    model = MaxPooling2D(pool_size=(2, 2))(model)

    # 128
    model = Conv2D(filters=128, kernel_size=(3, 3), activation='relu', kernel_initializer=init, padding="same")(model)
    model = BatchNormalization()(model)
    model = Conv2D(filters=128, kernel_size=(3, 3), activation='relu', kernel_initializer=init, padding="same")(model)
    model = BatchNormalization()(model)
    model = MaxPooling2D(pool_size=(2, 2))(model)
    ...
    # 64
    model = Conv2D(filters=256, kernel_size=(3, 3), activation='relu', kernel_initializer=init, padding="same")(model)
    model = BatchNormalization()(model)
    model = Conv2D(filters=256, kernel_size=(3, 3), activation='relu', kernel_initializer=init, padding="same")(model)
    model = BatchNormalization()(model)
    model = Conv2D(filters=256, kernel_size=(3, 3), activation='relu', kernel_initializer=init, padding="same")(model)
    ...
    # 32
    model = Conv2D(filters=512, kernel_size=(3, 3), activation='relu', kernel_initializer=init, padding="same")(model)
    model = BatchNormalization()(model)
    model = Conv2D(filters=512, kernel_size=(3, 3), activation='relu', kernel_initializer=init, padding="same")(model)
    model = BatchNormalization()(model)
    model = Conv2D(filters=512, kernel_size=(3, 3), activation='relu', kernel_initializer=init, padding="same")(model)
    ...
    model = Conv2D(filters=512, kernel_size=(3, 3), dilation_rate=dilation, activation='relu', kernel_initializer=init,
                   padding="same")(model)
    model = BatchNormalization()(model)
    model = Conv2D(filters=512, kernel_size=(3, 3), dilation_rate=dilation, activation='relu', kernel_initializer=init,
                   padding="same")(model)
    ...
    model = Conv2D(filters=256, kernel_size=(3, 3), dilation_rate=dilation, activation='relu', kernel_initializer=init,
                   padding="same")(model)
    model = BatchNormalization()(model)

    # 64
    model = UpSampling2D(size=(2, 2))(model)
    model = Conv2D(filters=128, kernel_size=(3, 3), dilation_rate=dilation, activation='relu', kernel_initializer=init,
                   padding="same")(model)
    model = BatchNormalization()(model)

    # 128
    model = UpSampling2D(size=(2, 2))(model)
    model = Conv2D(filters=64, kernel_size=(3, 3), dilation_rate=dilation, activation='relu', kernel_initializer=init,
                   padding="same")(model)
    model = BatchNormalization()(model)
