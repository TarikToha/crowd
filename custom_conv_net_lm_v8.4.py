...
if not resume:
    ...
    model = Conv2D(filters=256, kernel_size=(3, 3), dilation_rate=dilation, kernel_initializer=init,
                   padding="same")(model)
    model = BatchNormalization()(model)
    model = LeakyReLU()(model)

    route = model
    model = Conv2D(filters=128, kernel_size=(1, 1), dilation_rate=dilation, kernel_initializer=init,
                   padding="same")(model)
    model = BatchNormalization()(model)
    model = LeakyReLU()(model)
    model = Conv2D(filters=256, kernel_size=(3, 3), dilation_rate=dilation, kernel_initializer=init,
    ...
    model = Conv2D(filters=128, kernel_size=(3, 3), dilation_rate=dilation, kernel_initializer=init,
                   padding="same")(model)
    model = BatchNormalization()(model)
    model = LeakyReLU()(model)
    model = Conv2D(filters=128, kernel_size=(3, 3), dilation_rate=dilation, kernel_initializer=init,
    ...
    model = Conv2D(filters=64, kernel_size=(3, 3), dilation_rate=dilation, kernel_initializer=init,
                   padding="same")(model)
    model = BatchNormalization()(model)
    model = LeakyReLU()(model)
    model = Conv2D(filters=64, kernel_size=(3, 3), dilation_rate=dilation, kernel_initializer=init,
    ...
    model = Conv2D(filters=32, kernel_size=(3, 3), dilation_rate=dilation, kernel_initializer=init,
                   padding="same")(model)
    model = BatchNormalization()(model)
    model = LeakyReLU()(model)
    model = Conv2D(filters=16, kernel_size=(1, 1), dilation_rate=dilation, kernel_initializer=init,
                   padding="same")(model)
    model = BatchNormalization()(model)
    model = LeakyReLU()(model)
    model = Conv2D(filters=32, kernel_size=(3, 3), dilation_rate=dilation, kernel_initializer=init,
