...
def update_database(count, img_id, pred_time):
    ...
    sql = "UPDATE people SET count = %s, time = %s, updated_at = %s WHERE id = %s"
    val = (count, pred_time, updated_at, img_id)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(prog='localization_rpi.py')
    ...
    if not debug:
        ...
        img = 'data/2021-10-14 11_18_35.jpg'
        ml = 'best_models/multi_v8.2.5_bcep_adam_512_4_ucf_18v1_best'
        id = 10
